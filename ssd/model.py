...
class SSDLiteModel(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log(
            'train_loss', loss.detach(), on_step=True, 
            on_epoch=True, prog_bar=True, logger=True
        )
        self.log(
            'box_loss', loss_dict['bbox_regression'].detach(), on_step=True, 
            on_epoch=True, prog_bar=True, logger=True
        )
        self.log(
            'cls_loss', loss_dict['classification'].detach(), on_step=True, 
            on_epoch=True, prog_bar=True, logger=True
        )
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_map50', avg_map['map_50'].detach(), on_step=True, 
            on_epoch=True, prog_bar=True, logger=True
        )
